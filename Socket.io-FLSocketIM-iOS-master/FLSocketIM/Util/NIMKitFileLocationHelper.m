...
//    }
//    NSString* userDirectory = [NSString stringWithFormat:@"%@%@/%@/",documentPath,userID,@"mydownload"];
    NSString *download = [NSString stringWithFormat:@"%@%@/",[NIMKitFileLocationHelper userDirectory],@"mydownload"];
